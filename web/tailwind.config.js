...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // shadcn/redesign tokens (CSS-variable driven, see index.css)
        border: 'var(--border)',
        input: 'var(--input)',
        ring: 'var(--ring)',
        ...
        // Primary: redesign token (DEFAULT/foreground) + legacy sky scale kept
        // for the existing pages that use primary-500/600/700, etc.
        primary: {
          DEFAULT: 'var(--primary)',
